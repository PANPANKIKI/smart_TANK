"""
Smart Refueling System v15.7_AntiBlur_Stable_Fixed
==================================================
Fixes:
1. ป้องกันภาพเบลอตอนรถวิ่งผ่าน: เพิ่มระบบ Strict Counter ตรวจเช็กค่าตัวเลขมิเตอร์น้ำมัน
   ต้องเป็น "ตัวเลขเดิมชุดเดียวกันเป๊ะ" ติดต่อกันเป็นเวลาอย่างน้อย 5 วินาที จึงยอมล็อกบันทึก
2. แก้ไขบั๊ก API 403 (Limit Exceeded): เพิ่มกลไกการสุ่มกระจายคิวโหลดและตรวจเช็ก Cooldown 30 วินาที
3. ปรับระดับ Contrast ของ Image Thresholding เพื่อลบขอบสีจางที่ทำให้ Tesseract สับสนเป็นเลข 2
4. [HOTFIX] เพิ่มระบบป้องกันเฟรมว่าง (frame is None) ป้องกันโปรแกรมดับจากข้อผิดพลาด exit code -8
"""
